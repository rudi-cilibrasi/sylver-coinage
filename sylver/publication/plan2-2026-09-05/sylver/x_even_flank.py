...
X is one boundary of the move-26 campaign. U={16,26,88} is P iff X and
Q={16,26,88,98} are both N (U_REDUCTION_CORRECTION_2026-09-05.md).
X's odd replies are refuted through 407. Its even replies form a finite
set (all are now refuted; see PLAN2_RESULTS_2026-09-05.md). Any even child of X that
